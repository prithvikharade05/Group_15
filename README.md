...
- Immersive UX: Cinematic landing page and data-rich dashboard (`frontend/src/pages/Landing.jsx`, `frontend/src/pages/Dashboard.jsx`) with model controls, prediction cards, and an embedded chat drawer.
...
2. Set a 4-7 digit MPIN to unlock protected views.
...
- Frontend (CRA defaults): `npm test`
