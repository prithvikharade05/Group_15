    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-lg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-30 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link to="/dashboard" className="text-slate-600 hover:text-purple-600 text-base font-semibold transition-all duration-300 hover:scale-105 transform font-inter tracking-wide">Dashboards</Link>
          ...
          <Link to="/dashboard" className="text-slate-600 hover:text-purple-600 text-base font-semibold transition-all duration-300 hover:scale-105 transform font-inter tracking-wide">Portfolio</Link>
          <Link to="/dashboard" className="text-slate-600 hover:text-purple-600 text-base font-semibold transition-all duration-300 hover:scale-105 transform font-inter tracking-wide">AI Insights</Link>
